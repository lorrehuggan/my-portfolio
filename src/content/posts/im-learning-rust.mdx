...
Just a quck post to let you know that ive decided to take my talents to Rust!

My original choice as my next programming lanuage to learn was Go, but after attending [Rust Nation 2023]('https://www.youtube.com/@rustnationuk'), I'm committing to learning Rust as a TypeScript developer! The event was such an incredible experience, and it convinced me that this is the right path for me to take.
...
Not only that, but Rust has become increasingly popular in recent years, especially in the realm of systems programming and backend development and even sneaking its way slowly but surely into front-end web development. By learning Rust, I'll be better equipped to work on a wider range of projects and collaborate with a broader community of developers.
